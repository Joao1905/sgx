...
class Agent:
    ...
    def __init__(self, monitor_delay_secs = 10, collect_interval_secs = 3, metrics_file_path = False):
        insufficient_time_delay = collect_interval_secs * 3 > monitor_delay_secs
        ...
        self.__cpu_collect_interval = collect_interval_secs
        self.__monitor_delay_secs = monitor_delay_secs
    ...
    def __collect_and_persist_data(self):
        ...
        metric = Metric(cpu_usage_percent, mem_usage_gb)
